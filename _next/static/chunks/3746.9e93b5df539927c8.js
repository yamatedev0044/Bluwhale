    ...
    3746: (e, t, n) => {
      ...
      class ev {
        ...
        static load(e) {
          let t = e.getItem(ey),
            n = e.getItem(ew),
            s = e.getItem(eb);
          return t && s ? new ev(e, t, s, "1" === n) : null;
        }
        get linked() {
          return this._linked;
        }
      ...
      let eM = (e) =>
        ...
        eA = ({ autoExpand: e, message: t, menuItems: n }) => {
          let [s, i] = (0, eS.useState)(!0),
            [r, a] = (0, eS.useState)(null != e && e);
          return (
            (0, eS.useEffect)(() => {
              let e = [
                window.setTimeout(() => {
      ...
      class eT {
        ...
        subscribe() {
          let e = ev.load(this.storage) || ev.create(this.storage),
            ...
            s = this.isMobileWeb ? new eL() : new eP();
        ...
        requestEthereumAccounts() {
          ...
          return new Promise((e, t) => {
            this.relayEventManager.callbacks.set(s, (n) => {
              ...
              eT.accountRequestCallbackIds.add(s),
      ...
      class eW {
        constructor(e) {
          (this._relay = null),
            (this._addresses = []),
            (this.metadata = e.metadata),
            (this._storage = new s("walletlink", eR)),
        ...
        async addEthereumChain(e) {
          ...
          let r = this.initializeRelay(),
            ...
            h = await r.addEthereumChain(i.toString(), a, c, o, l, u);
          if (eu(h)) return !1;
          ...
          let r = this.initializeRelay(),
            a = await r.sendRequest({
              ...
              params: {
                ...
                message: M(
                  {
                    eth_signTypedData_v1: el.hashForSignTypedDataLegacy,
                    eth_signTypedData_v3: el.hashForSignTypedData_v3,
                    eth_signTypedData_v4: el.hashForSignTypedData_v4,
                    eth_signTypedData: el.hashForSignTypedData_v4,
                  }[t]({
                    data: (function (e) {
      ...
      let eq = "SignerType",
        ez = new s("CBWSDK", "SignerConfigurator");
      async function eK(e) {
        let {
          communicator: t,
          metadata: n,
      ...
      async function eF(e, t, n) {
        ...
        let s = new eW({ metadata: t, callback: n });
        e.postMessage({
...
Please see https://www.smartwallet.dev/guides/tips/popup-tips#cross-origin-opener-policy for more information.`,
      ...
      let eZ = { options: "all" };
      function eX(e) {
        new s("CBWSDK").setItem("VERSION", ee), eB();
        let t = {
          metadata: {
        ...
        o = {
          encodeData(e, t, n, a = !0) {
            ...
            if (a) {
              ...
              for (let s of n[e]) {
                let [e, n] = c(s.name, s.type, t[s.name]);
                o.push(e), l.push(n);
              }
            } else
              for (let r of n[e]) {
                ...
                if (void 0 !== e)
                  ...
                  else o.push(r.type), l.push(e);
              }
            return r.rawEncode(o, l);
          },
          encodeType(e, t) {
            let n = "",
    ...
    50755: (e, t, n) => {
      ...
      function w(e, t) {
        var n = _(s++, 3);
        !u.__s && L(n.__H, t) && ((n.__ = e), (n.u = t), i.__H.__h.push(n));
      }
      function v(e, t) {
        var n = _(s++, 4);
        !u.__s && L(n.__H, t) && ((n.__ = e), (n.u = t), i.__h.push(n));
      }
      function k(e) {
        return (
          (l = 5),
    ...
    59828: (e, t, n) => {
      ...
      function u(e, t) {
        ...
        if ((p = e).lastIndexOf("]") === p.length - 1) {
          ...
          return (n = o(e)), u("int256", c(t) * BigInt(2) ** BigInt(n[1]));
        throw Error("Unsupported or invalid type: " + e);
      }
      function d(e, t) {
        if (e.length !== t.length)
          throw Error("Number of types are not matching the values");
        for (var n, o, l = [], u = 0; u < e.length; u++) {
          var d = r(e[u]),
            h = t[u];
          if ("bytes" === d) l.push(h);
          else if ("string" === d) l.push(new s(h, "utf8"));
          else if ("bool" === d) l.push(new s(h ? "01" : "00", "hex"));
          else if ("address" === d) l.push(i.setLength(h, 20));
    ...
    66117: (e, t, n) => {
      ...
      function A() {
        for (var e, t, n, s, r, a, l = 1; o.length; )
          o.length > l && o.sort(u),
            (e = o.shift()),
            (l = o.length),
            e.__d &&
      ...
      function P(e, t, n, s, r, a, o, l, c, u, d) {
        var h,
          p,
          f,
          m,
                  ...
                  -1 !=
                    (u = o.__i =
                      (function (e, t, n, s) {
                        ...
                        if (
                          (null === l && null == e.key) ||
                          (l && a == l.key && o == l.type && 0 == (2 & l.__u))
                        )
                          return n;
                        if (s > +(null != l && 0 == (2 & l.__u)))
        ...
        e: if ("style" == t)
          if ("string" == typeof n) e.style.cssText = n;
            ...
            if (("string" == typeof s && (e.style.cssText = s = ""), s))
              for (t in s) (n && t in n) || D(e.style, t, "");
            if (n) for (t in n) (s && n[t] == s[t]) || D(e.style, t, n[t]);
          }
        else if ("o" == t[0] && "n" == t[1])
          (r = t != (t = t.replace(d, "$1"))),
            (t =
      ...
      function L(e, t, n, r, a, o, l, c, u, d) {
        var h,
          p,
          f,
          m,
        ...
        128 & n.__u && ((u = !!(32 & n.__u)), (o = [(c = t.__e = n.__e)])),
          (h = i.__b) && h(t);
        e: if ("function" == typeof W)
          try {
            ...
            (p.state = p.__s),
              ...
              (c = P(e, b(j) ? j : [j], t, n, r, a, o, l, c, u, d)),
              (p.base = t.__e),
              (t.__u &= -161),
                ...
                (function (e, t, n, r, a, o, l, c, u) {
                  ...
                  if (null == e) {
                    ...
                    (e = document.createElementNS(a, I, k.is && k)),
                      c && (i.__m && i.__m(t, o), (c = !1)),
                      (o = null);
                  }
                  if (null == I) w === k || (c && e.data == k) || (e.data = k);
                  else {
                    if (
      ...
      function q(e, t, n) {
        ...
        t))
          "key" == a
            ...
            : "ref" == a
            ? (r = t[a])
            : (l[a] = null == t[a] && null != o ? o[a] : t[a]);
        return (
          arguments.length > 2 &&
            (l.children = arguments.length > 3 ? s.call(arguments, 2) : n),
          I(e.type, l, i || e.key, r || e.ref, null)
        );
      }
      function z(e) {
        function t(e) {
