    ...
    63439: (e, t, n) => {
      ...
      var eE = {
        ...
        eW = {
          ...
          iconUrl: async () => (await n.e(1070).then(n.bind(n, 31070))).default,
        },
        eq = {
        ...
        eK = Object.fromEntries(
          Object.values({
            ...
            goerli: { chainId: 5, ...e_ },
            gravity: { chainId: 1625, name: "Gravity", ...eA },
            gravitySepolia: { chainId: 13505, name: "Gravity Sepolia", ...eA },
            hardhat: {
              chainId: 31337,
              iconBackground: "#f9f7ec",
              iconUrl: async () =>
      ...
      function tt(e) {
        let { address: t, includeBalance: n } = e,
          ...
          { data: o } = (0, m.useBalance)({ address: n ? t : void 0 });
      ...
      function tO() {
        let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
          ...
          { setIsWalletConnectModalOpen: o } = am(),
        ...
        let c = async (e, t) => {
          ...
          g = tU()
            ...
            .slice(0, 3),
          h = [];
        for (let e of tA({ wallets: f, recentWallets: g })) {
          var p, C, b, j;
          if (!e) continue;
          let t = t_(e),
            n = tT(g, e.id);
      ...
      function tV(e) {
        ...
        let m = J(),
          { address: f, chain: v } = (0, c.useAccount)(),
          { signMessageAsync: g } = (0, I.useSignMessage)(),
          h = async () => {
            try {
              let e,
      ...
      function t7(e) {
        ...
        if (
          ...
          (0, j.useAccountEffect)({ onDisconnect: tJ }),
          "function" == typeof d)
        )
          throw Error(
      ...
      function nw(e) {
        let { onClose: t, open: n } = e,
          ...
          { chains: l } = (0, d.useConfig)(),
          [o, i] = (0, r.useState)(null),
          { switchChain: s } = (0, T.useSwitchChain)({
            mutation: {
              onMutate: (e) => {
                let { chainId: t } = e;
                i(t);
          ...
          { disconnect: m } = (0, w.useDisconnect)(),
      ...
      var nU = function (e) {
        ...
        nO = (e) => (e ? [nU(e, 0.2), nU(e, 0.14), nU(e, 0.1)] : null),
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  "clipPath",
                  { id: "clip-wrapper" },
                  r.createElement("rect", { height: m, width: m })
                ),
                r.createElement(
                  "clipPath",
                  { id: "clip-logo" },
      ...
      var nQ = async () => {
        ...
        n3 = async () => {
          switch (tk()) {
            ...
            case "macOS":
              return (await n.e(5950).then(n.bind(n, 45950))).default;
            default:
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              (null == a ? void 0 : a.qrCode)
                ? r.createElement(nJ, { logoSize: 0, size: 268, uri: a.qrCode })
                : null
            ),
            r.createElement(
              ee,
              ...
              : t.steps.map((e, t) => {
                  ...
                  return r.createElement(
                    ...
                    r.createElement(
                      ...
                      null == (n = n8[e.step]) ? void 0 : n.call(n8, i)
                    ),
                    r.createElement(
                      ee,
                      { display: "flex", flexDirection: "column", gap: "4" },
              ...
              : t.steps.map((e, t) => {
                  ...
                  return r.createElement(
                    ...
                    r.createElement(
                      ...
                      null == (n = n8[e.step]) ? void 0 : n.call(n8, o)
                    ),
                    r.createElement(
                      ee,
                      { display: "flex", flexDirection: "column", gap: "4" },
      ...
      function at(e) {
        ...
        switch (_) {
          case "NONE":
            A = r.createElement(nx, { getWallet: () => I("GET") });
            break;
          case "LEARN_COMPACT":
          ...
          case "CONNECT":
            (A =
              ...
              (U = f ? (C ? null : "NONE") : null),
              (t = f ? (C ? () => {} : D) : () => {});
            break;
          case "DOWNLOAD_OPTIONS":
            (A = o && r.createElement(n2, { changeWalletStep: I, wallet: o })),
              (M = o && g.t("get_options.short_title", { wallet: o.name })),
              (U = C ? "CONNECT" : f ? "NONE" : T);
            break;
          case "DOWNLOAD":
            (A = o && r.createElement(n4, { changeWalletStep: I, wallet: o })),
              (M = o && g.t("get_mobile.title", { wallet: o.name })),
              (U = O ? "DOWNLOAD_OPTIONS" : T);
            break;
          case "INSTRUCTIONS_MOBILE":
            (A = o && r.createElement(n5, { connectWallet: B, wallet: o })),
              (M =
                o &&
          ...
          case "INSTRUCTIONS_EXTENSION":
            (A = o && r.createElement(n9, { wallet: o })),
              (M =
                o &&
                g.t("get_options.title", {
                  wallet: (f && o.shortName) || o.name,
          ...
          case "INSTRUCTIONS_DESKTOP":
            (A = o && r.createElement(ae, { connectWallet: B, wallet: o })),
              (M =
                o &&
                g.t("get_options.title", {
                  wallet: (f && o.shortName) || o.name,
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                a ? r.createElement(an, { wallet: n }) : null,
                r.createElement(er, {
                  background: o,
                  borderRadius: "13",
                      ...
                      .map((e) =>
                        r.createElement(
                          ...
                          r.createElement(
                            ee,
                            { width: "60" },
                            r.createElement(aa, { onClose: t, wallet: e })
                          )
                        )
                      )
                  )
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ee,
              { width: "60" },
              r.createElement(aa, { onClose: t, wallet: n, connecting: !0 })
            ),
            r.createElement(
              ee,
              { marginTop: "20" },
      ...
      function au(e) {
        let { children: t } = e,
          { closeModal: n, isModalOpen: a, openModal: l } = as(),
          { closeModal: o, isModalOpen: i, openModal: s } = as(),
          { closeModal: u, isModalOpen: m, openModal: f } = as(),
          [v, g] = (0, r.useState)(!1),
          h = Z(),
          { chainId: p } = (0, c.useAccount)(),
          { chains: C } = (0, d.useConfig)(),
          b = C.some((e) => e.id === p),
          w = (0, r.useCallback)(
            function () {
        ...
        return (
          ...
          r.createElement(
            ...
            t,
            r.createElement(ai, { onClose: n, open: a }),
      ...
      function ag(e) {
        ...
        let { children: o } = e,
          ...
          { chainId: u } = (0, c.useAccount)(),
          { chains: m } = (0, d.useConfig)(),
          f = m.some((e) => e.id === u),
          v = e$(),
          g = null != (t = K()) ? t : void 0,
          h = u ? v[u] : void 0,
        ...
        return r.createElement(
          ...
          o({
            ...
            connectModalOpen: A,
            mounted: i(),
            openAccountModal: null != S ? S : av,
            openChainModal: null != T ? T : av,
            openConnectModal: null != I ? I : av,
          })
        );
      }
      ag.displayName = "ConnectButton.Custom";
      var ah = {
        accountStatus: "full",
      ...
      function ap(e) {
        let {
            accountStatus: t = ah.accountStatus,
            chainStatus: n = ah.chainStatus,
            label: a = ah.label,
            showBalance: l = ah.showBalance,
          } = e,
          o = eJ(),
          i = Z(),
          { setShowBalance: s } = e1(),
      ...
      (ap.__defaultProps = ah), (ap.Custom = ag);
      var aC = (e) => {
        ...
        ab = (e, t) => {
          ...
          let s = -1,
            ...
            u = [],
            d = [],
            m = aC({ appName: l, appDescription: o, appUrl: r, appIcon: i });
      ...
      function ak(e) {
        ...
        return (!!n && void 0 !== ax(n)) || (!!t && void 0 !== ay(t));
      }
      function aB(e) {
        var t;
      ...
      var aT = (e) => {
          ...
          return {
            ...
            createConnector: s
              ? aE({ projectId: o, walletConnectParameters: r })
              : aB({
                  target:
                    "undefined" != typeof window
                      ? null !=
        ...
        aA = (e) => e.reduce((e, t) => ((e[t.id] = (0, _.L)()), e), {}),
        aM = (e) => {
          let {
              appName: t,
              appDescription: n,
            ...
            d = aC({ appName: t, appDescription: n, appUrl: a, appIcon: l }),
            m = ab(
              o || [{ groupName: "Popular", wallets: [a_, aS, aD, aT, aN] }],
              {
                projectId: r,
                appName: t,
                appDescription: n,
