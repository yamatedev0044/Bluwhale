  ...
  [4874],
  {
    ...
    6185: (e, t, r) => {
      ...
      async function eu({ hash: e, signature: t }) {
        var r = await el({ hash: e, signature: t });
        let i = eo(`0x${r.substring(4)}`).substring(26);
        return (function (e, t) {
      ...
      function eW(e = p.FIVE_MINUTES, t) {
        let r,
          ...
          s,
          n,
          o = (0, p.toMiliseconds)(e || p.FIVE_MINUTES);
        return {
          resolve: (e) => {
    ...
    30565: (e, t, r) => {
      ...
      async function tA(e, t, r, s, n = (0, i.fromMiliseconds)(Date.now())) {
        let o = { alg: "EdDSA", typ: "JWT" },
          a = { iss: tS(s.publicKey), sub: e, aud: t, iat: n, exp: n + r },
          c = tI(
        ...
        return [tD(h.header), tD(h.payload), t_(h.signature, eS)].join(".");
      }
    },
    31498: (e, t) => {
      "use strict";
